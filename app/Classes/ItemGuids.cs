...
namespace Landmark.Classes
{
    public abstract class ItemGuids
    {
        ...
        public static readonly String T23PageABTemplate = "{2EE73BEB-F8DA-4F35-BB46-C1B0B8AC3945}";
        public static readonly String T23PageCTemplate = "{2F6A4A9C-C7DC-439D-8310-3A2EF0617158}";
        // public static readonly String T23PageABTemplate = "{2EE73BEB-F8DA-4F35-BB46-C1B0B8AC3945}";
