...
namespace Landmark.Classes
{
    public static class SitecoreItems
    {
        ...
        public static readonly Item DiscoverMoreItem = _web.GetItem("{0BA79670-6D57-473C-B495-1A01DB6CA2CA}");
        ...
        public static readonly Item PleaseSelectItem = _web.GetItem("{F40D2AD4-00D1-49BB-AFF5-EDCF62DA9668}");
