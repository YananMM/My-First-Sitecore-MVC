...
$(document).ready(function() {
  ...
  $('.t13').each(function(){
    ...
    // brands link scroll for right column and popup overlay
    $('.brand-menu-area .brands-gap>li>a, .popup-overlay .brands>li>a, .popup-overlay .brands-gap>li>a').on('click', function(e){
