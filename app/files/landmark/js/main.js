...
jQuery(function ($) {
    $(document).ready(function () {
        ...
        if ($('body').hasClass('t22-is')) {
            ...
            function rearrangeItems(page) {
                ...
                for (i = 0; i < items_L.length; i++) {
                    items.push(items_L[i].innerHTML);
                    if (i < items_R.length) items.push(items_R[i].innerHTML);
                }

                if (page == 0) {
                    // if sorting the first page, remove items on page
                    $('#gd-art-gallery > .col-sm-6').html('');
                } else {
        ...
        if ($('body').hasClass('t3') || $('body').hasClass('t15') || $('body').hasClass('t26')) {
            ...
            $('.gd-promo-filter a[data-filter]').click(function () {
